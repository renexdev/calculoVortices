...
#Inputs
MAT = "Bi2212"
filename="d05_20G_30um_07_5000_ss44_blur_10_v1"#default: test
px2um = 0.114791667 #2000 x
px2um = 0.045916667 #5000 x
...
#see lambda_in line!!!
lambda_kees = 0.69352 #kees curve Tc=86.0K- meas Tc=86.7K #[lambda_kees] = um
...
lambdaT_in=lambda_kees #um #experimental lambda
print "Using lambda from Kees curve", lambdaT_in, "um"
